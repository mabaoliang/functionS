...
-(NSArray *)arrKey
{
    if (!_arrKey) {
        ...
        _arrKey=@[@"二维码生成",@"扫描二维码",@"手势解锁",@"重力感应",@"transForm",@"下拉框",@"自定义键盘"];
    }
...
{
    if (!_arrValueClass) {
        _arrValueClass=@[@"GenerateQrCodeViewController",@"ScanQrCodeViewController",@"GesticulationViewController",@"GravityInductionViewController",@"TransformViewController",@"DropDownBoxViewController",@"KeyBoardViewController"];
    }
